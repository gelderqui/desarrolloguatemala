                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="entidad" class="form-control" placeholder="Entidad que tabaja">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select v-model="iddep" class="form-control">
                                            ...
                                            <option v-for="dep in arrayDep" :key="dep.id" :value="dep.id" v-text="dep.nombre"></option>
                                        </select>
                                    </div>
                                </div>
        ...
        methods : {
            ...
            selectDep(){
                ...
                axios.get(url).then(function (response) {
                    //console.log(response);
                    var respuesta= response.data;
                    me.arrayDep = respuesta.departamentos;
                })
                .catch(function (error) {
                    console.log(error);
                });
            ...
            validarPersona(){
                ...
                if (!this.password) this.errorMostrarMsjPersona.push("La password del usuario no puede estar vacía.");
                 if (!this.password) this.errorMostrarMsjPersona.push("La entidad no puede estar vacía.");
                if (this.idrol==0) this.errorMostrarMsjPersona.push("Seleccione una Role.");
                if (this.iddep==0) this.errorMostrarMsjPersona.push("Seleccione un Departamento.");
