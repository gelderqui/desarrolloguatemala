    ...
    <div class="container" role="main">
        <div class="header">                      
            <div class="header-right">                
                ...
                <!--ESTE ES EL LOGIN-->
                <a href="{{ route('login')}}" class="btn btn-primary px-6" style="position: absolute; top: 0; right: 0;">USUARIOS</a>
            </div>
        </div>
        <article>
            <div class="card-group mb-0">
                <div class="card bg-light p-4">
                    <form action="form-horizontal was-validated">
                        <div class="card-body">   
                        <br><br> <a href="https://www.mesoamericana.edu.gt"><img src="img/meso.png" alt="meso" width="45%" title="Universidad Mesoamericana"></a>
                            <a href="http://www.gruposgestores.org.gt/2011/"><img src="img/logo.png" alt="grupos" width="45%" title="Grupos Gestores"></a>
                            <img src="img/competi.png" alt="competi" width="90%">
                            <div class="row">
                                <div class="col-6">
                                  <!---->
                                    <br><a href="{{ route('main')}}" class="btn btn-warning px-6" title="Página principal">ESTADISTICAS DEL ICD ACTUAL</a><br><br>
                                </div>
                            </div> 
                            <img src="img/com.png" alt="com" width="80%">
